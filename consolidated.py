...
def llama_summarize(text, summary_length="500 words"):
    ...
    length_map = {
        ...
        "less than 1000 words": "Summarize the following text and include all the key pointsin less than 1000 words.",
        "more than 1000 words": "Provide a detailed summary and include all the key pointsof more than 1000 words."
    }
    ...
    for filename in os.listdir(pdf_folder_path):
        if filename.endswith(".pdf"):
            ...
            if any(keyword.lower() in pdf_text.lower() for keyword in keywords):
                ...
                #st.markdown(f'- **File: {download_link}**', unsafe_allow_html=True)
...
def handle_uploaded_file(uploaded_file, summary_length):
    ...
    if uploaded_file is not None:
        ...
        #st.write(f"Summary of the uploaded file ({uploaded_file.name}):")
